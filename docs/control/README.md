对于Control目录下的代码与算法的一些说明：

1. 输入给算法的轨迹中的yaw：倒车和前进时轨迹和自车都是指向车头方向，往左为正，往右为负
2. 车头方向为x正方向，左侧为y正方向
3. 横向误差：车辆在轨迹左侧时为正，右侧时为负，无论前进后退
4. 航向误差：车头朝着轨迹正方向的左侧时为正，右侧为负
5. 转角请求：往左为正，往右为负
6. 速度方向：往前为正，往后为负
7. 曲率/半径方向：往左为正，往后为负
8. 横向误差偏左，就往左打，偏右就往右打
...
9. 航向误差偏左，方向需要能让车顺时针转，造就**负的**横摆角速度，减小航向误差，前进时往右，倒车时往左
